...
function EnrollmentForm({ enrollment, onClose, onSaved }) {
    ...
    // Helper to build a readable label for each course offering option
                        ...
                        {!isEditing && (
                            <>
                                ...
                                <div className="mb-2">
                                    ...
                                    <select name="course_offering_id" className="form-select" value={formData.course_offering_id} onChange={handleChange} required>
                                ...
                                <div className="mb-2">
                                    ...
                                    <input type="date" name="enrollment_date" className="form-control" value={formData.enrollment_date} onChange={handleChange} />
                                </div>
                            </>
                        )}
                        <div className="mb-2">
